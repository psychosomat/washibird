var _ComposeCssObj = {
	...
	aLightBlockquoteBackgroundColor: new Array(
		PrimaryGlobals.nPrimary_MAX_LEVELS,
	),
	...
	initMain: () => {
		...
		// get preferences
		_ComposeCssObj.getPrimaryPreferences();

		return _ComposeCssObj.generateStyleBlock();
	},
	...
	getPrimaryPreferences: function () {
		consoleDebug(
			"[PrimaryDebug] [background.js]: ComposeCssObj.getPrimaryPreferences",
		);
		...
		this.bEnableBlockquoteBackgroundColor =
			variableList.enableBlockquoteBackgroundColor;
		...
		this.sBorderTopStyle = variableList.borderposition_top
			? sBorderStyle
			: "none";
		this.sBorderBottomStyle = variableList.borderposition_bottom
			? sBorderStyle
			: "none";
		...
		this.bEnableUsermsgcolorsOnCompose =
			variableList.enableUsermsgcolorsOnCompose;
		...
		this.aLightBlockquoteTextColor[0] =
			variableList.primaryLightBlockquoteTextColor1;
		this.aLightBlockquoteTextColor[1] =
			variableList.primaryLightBlockquoteTextColor2;
		this.aLightBlockquoteTextColor[2] =
			variableList.primaryLightBlockquoteTextColor3;
		this.aLightBlockquoteTextColor[3] =
			variableList.primaryLightBlockquoteTextColor4;
		this.aLightBlockquoteTextColor[4] =
			variableList.primaryLightBlockquoteTextColor5;
		this.aLightBlockquoteBackgroundColor[0] =
			variableList.primaryLightBlockquoteBackgroundColor1;
		this.aLightBlockquoteBackgroundColor[1] =
			variableList.primaryLightBlockquoteBackgroundColor2;
		this.aLightBlockquoteBackgroundColor[2] =
			variableList.primaryLightBlockquoteBackgroundColor3;
		this.aLightBlockquoteBackgroundColor[3] =
			variableList.primaryLightBlockquoteBackgroundColor4;
		this.aLightBlockquoteBackgroundColor[4] =
			variableList.primaryLightBlockquoteBackgroundColor5;
		...
		this.aDarkBlockquoteTextColor[0] =
			variableList.primaryDarkBlockquoteTextColor1;
		this.aDarkBlockquoteTextColor[1] =
			variableList.primaryDarkBlockquoteTextColor2;
		this.aDarkBlockquoteTextColor[2] =
			variableList.primaryDarkBlockquoteTextColor3;
		this.aDarkBlockquoteTextColor[3] =
			variableList.primaryDarkBlockquoteTextColor4;
		this.aDarkBlockquoteTextColor[4] =
			variableList.primaryDarkBlockquoteTextColor5;
		this.aDarkBlockquoteBackgroundColor[0] =
			variableList.primaryDarkBlockquoteBackgroundColor1;
		this.aDarkBlockquoteBackgroundColor[1] =
			variableList.primaryDarkBlockquoteBackgroundColor2;
		this.aDarkBlockquoteBackgroundColor[2] =
			variableList.primaryDarkBlockquoteBackgroundColor3;
		this.aDarkBlockquoteBackgroundColor[3] =
			variableList.primaryDarkBlockquoteBackgroundColor4;
		this.aDarkBlockquoteBackgroundColor[4] =
			variableList.primaryDarkBlockquoteBackgroundColor5;
	...
	generateStyleBlock: function () {
		...
		if (this.bEnableQuotecolorsOnCompose) {
			for (i = 0; i < PrimaryGlobals.nPrimary_MAX_LEVELS; i++) {
				sBlockquoteSelectorLevel = "";
				for (j = 0; j <= i; j++) {
				...
				if (this.bGraphQuotEn) {
					...
					if (this.bCollapseBorders) {
						if (i > 0) {
							leftmargin = !this.bBorderLeftEn ? 1.0 : 1.0;
							rightmargin = !this.bBorderRightEn ? 1.0 : 1.0;
							...
							sPrimaryLightCSS +=
								"margin-block: 8px !important; padding: 16px !important;";
							sPrimaryDarkCSS +=
								"margin-block: 8px !important; padding: 16px !important;";
						}
					} else {
			...
			if (this.bCollapseBorders) {
				sPrimaryLightCSS +=
					"blockquote[type=cite] pre{margin-left: 0em !important; margin-right: 0em !important;}\n";
				sPrimaryDarkCSS +=
					"blockquote[type=cite] pre{margin-left: 0em !important; margin-right: 0em !important;}\n";
			}
		}
		...
		if (this.bUseCustomMsgColors && this.bEnableUsermsgcolorsOnCompose) {
			...
			sPrimaryLightCSS += `body {color: ${this.sLightTextColor}; background: ${this.sLightBgColor};}\n`;
			sPrimaryDarkCSS += `body {color: ${this.sDarkTextColor}; background: ${this.sDarkBgColor};}\n`;
